	...
	; Compiler options:
	;
	; -oNEC IR Receiver Repet Code Momentary ON.cof \
	; -mNEC IR Receiver Repet Code Momentary ON.map --summary=default \
	; --output=default main.p1 --chip=12F675 -P --runtime=default \
